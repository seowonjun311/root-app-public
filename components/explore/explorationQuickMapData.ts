/*
 * ROOT 탐험 탭의 빠른 전국 지도 형상 데이터입니다.
 *
 * 화면 동작과 터치 처리는 app/(tabs)/explore.tsx에 남기고,
 * 시·도 및 시·군·구의 단순화 SVG 좌표만 이 파일에서 관리합니다.
 */

export type ExplorationRegionId =
  | 'seoul'
  | 'busan'
  | 'incheon'
  | 'gangwon'
...
export type KoreaRegionShape = {
  id: ExplorationRegionId;
  shortLabel: string;
  points: string;
  labelX: number;
  labelY: number;
 ...
 * 도 → 광역시 순서로 배치했습니다.
 */
export const KOREA_REGION_SHAPES: KoreaRegionShape[] = [
  {
    id: 'gyeonggi',
    shortLabel: '경기',
    points:
...
export type SeoulDistrictShape = {
  id: string;
  name: string;
  points: string;
  labelX: number;
...
export const SEOUL_DISTRICT_SHAPES: SeoulDistrictShape[] = [
...
export type GyeonggiDistrictShape = {
  id: string;
  name: string;
  icon: string;
  subtitle: string;
 ...
 */
export const GYEONGGI_DISTRICT_SHAPES: GyeonggiDistrictShape[] = [
...
export type BusanDistrictShape = {
  id: string;
  name: string;
  icon: string;
  subtitle: string;
 ...
 */
export const BUSAN_DISTRICT_SHAPES: BusanDistrictShape[] = [
  {
    id: 'busan-gangseo',
    name: '강서구',
    icon: '🌾',
...
export type IncheonDistrictShape = {
  id: string;
  name: string;
  icon: string;
  subtitle: string;
 ...
 */
export const INCHEON_DISTRICT_SHAPES: IncheonDistrictShape[] = [
  {
    id: 'incheon-ganghwa',
    name: '강화군',
    icon: '🏯',
...
export type DaeguDistrictShape = {
  id: string;
  name: string;
  icon: string;
  subtitle: string;
 ...
 */
export const DAEGU_DISTRICT_SHAPES: DaeguDistrictShape[] = [
  {
    id: 'daegu-gunwi',
    name: '군위군',
    icon: '🛕',
...
export type DaejeonDistrictShape = {
  id: string;
  name: string;
  icon: string;
  subtitle: string;
 ...
 */
export const DAEJEON_DISTRICT_SHAPES: DaejeonDistrictShape[] = [
  {
    id: 'daejeon-yuseong',
    name: '유성구',
    icon: '🔬',
...
export type GwangjuDistrictShape = {
  id: string;
  name: string;
  icon: string;
  subtitle: string;
 ...
 * 기존 지역 상세 화면에 그대로 연결합니다.
 */
export const GWANGJU_DISTRICT_SHAPES: GwangjuDistrictShape[] = [
  {
    id: 'gwangju-gwangsan',
    name: '광산구',
    icon: '🌾',
...
export type GangwonDistrictShape = {
  id: string;
  name: string;
  icon: string;
  subtitle: string;
 ...
 */
export const GANGWON_DISTRICT_SHAPES: GangwonDistrictShape[] = [
  {
    id: 'gangwon-cheorwon',
    name: '철원군',
    icon: '🕊️',
...
export type ChungbukDistrictShape = {
  id: string;
  name: string;
  icon: string;
  subtitle: string;
 ...
 * 기존 장소·GPS·테마 데이터는 지역 상세 화면에서 그대로 사용합니다.
 */
export const CHUNGBUK_DISTRICT_SHAPES: ChungbukDistrictShape[] = [
  {
    id: 'chungbuk-chungju',
    name: '충주시',
    icon: '🏞️',
...
export type ChungnamDistrictShape = {
  id: string;
  name: string;
  icon: string;
  subtitle: string;
 ...
 * 기존 장소·GPS·테마 데이터는 지역 상세 화면에서 그대로 사용합니다.
 */
export const CHUNGNAM_DISTRICT_SHAPES: ChungnamDistrictShape[] = [
  {
    id: 'chungnam-dangjin',
    name: '당진시',
    icon: '🌅',
...
export type JeonbukDistrictShape = {
  id: string;
  name: string;
  icon: string;
  subtitle: string;
 ...
 * 기존 장소·GPS·테마 데이터는 지역 상세 화면에서 그대로 사용합니다.
 */
export const JEONBUK_DISTRICT_SHAPES: JeonbukDistrictShape[] = [
  {
    id: 'jeonbuk-gunsan',
    name: '군산시',
    icon: '🌊',
...
export type JeonnamDistrictShape = {
  id: string;
  name: string;
  icon: string;
  subtitle: string;
 ...
 * 기존 장소·GPS·테마 데이터는 지역 상세 화면에서 그대로 사용합니다.
 */
export const JEONNAM_DISTRICT_SHAPES: JeonnamDistrictShape[] = [
  {
...
export type GyeongbukDistrictShape = {
  id: string;
  name: string;
  icon: string;
  subtitle: string;
 ...
 * 기존 장소·GPS·테마 데이터는 지역 상세 화면에서 그대로 사용합니다.
 */
export const GYEONGBUK_DISTRICT_SHAPES: GyeongbukDistrictShape[] = [
  {
...
export type GyeongnamDistrictShape = {
  id: string;
  name: string;
  icon: string;
  subtitle: string;
 ...
 */
export const GYEONGNAM_DISTRICT_SHAPES: GyeongnamDistrictShape[] = [
  {
 ...
 */
export const JEJU_CITY_SHAPES: JejuCityShape[] = [
  {
    id: 'jeju-si',
    name: '제주시',
    icon: '🍊',
...
export type SejongDistrictShape = {
  id: 'sejong';
  name: string;
  icon: string;
  subtitle: string;
 ...
 */
export const SEJONG_DISTRICT_SHAPES: SejongDistrictShape[] = [
  {
    id: 'sejong',
    name: '세종특별자치시',
    icon: '🏛️',
...
export type UlsanDistrictShape = {
  id: string;
  name: string;
  icon: string;
  subtitle: string;
 ...
 * 기존 지역 상세 화면에 그대로 연결합니다.
 */
export const ULSAN_DISTRICT_SHAPES: UlsanDistrictShape[] = [
  {
    id: 'ulsan-ulju',
    name: '울주군',
    icon: '⛰️',
